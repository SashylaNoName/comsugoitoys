...
<div class="backgr" style="margin:0; padding:0; background-color: rgba(255, 255, 255, 0.7); width:100%; height: auto; display: flex; justify-content: center;">
...
<main>
    ...
    <div class="backgr" style="margin:0; padding:0; border-radius:25px; background-color: rgba(255, 255, 255, 0.7); width:auto; height: auto; display: flex; justify-content: center;">
        <h2>Новинки</h2>
        </div>
        <br><br>
        <div class="slider">
    ...
    <section class="products">
        <br><br><br>
    <div class="backgr" style="margin: 0;
    padding: 0;
    border-radius: 25px;
